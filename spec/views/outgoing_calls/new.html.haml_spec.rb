...
describe "outgoing_calls/new.html.haml" do
  before(:each) do
    assign(:outgoing_call, stub_model(OutgoingCall,
      :clid => "MyString",
      :src => "MyString",
      :dst => "MyString",
      :dcontext => "MyString",
  ...
  it "renders new outgoing_call form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => outgoing_calls_path, :method => "post" do
