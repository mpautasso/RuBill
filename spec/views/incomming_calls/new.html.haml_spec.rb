...
describe "incomming_calls/new.html.haml" do
  before(:each) do
    assign(:incomming_call, stub_model(IncommingCall,
      :clid => "MyString",
      :src => "MyString",
      :dst => "MyString",
      :dcontext => "MyString",
  ...
  it "renders new incomming_call form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => incomming_calls_path, :method => "post" do
